...
def create_modules(module_defs, img_size, cfg):
    ...
    """
    Function for training the network and saving the weights.

    Parameters:
      module_defs - list comprised of several module dictionaries, each dictionary originates from a block in cfg file
      img_size - image size after processing, default: (640, 640)
      cfg - cfg file path

    Returns:
        module_list - a list of Sequentials
        routs_binary - a vector of binary values (num_sequentials, )
    """
...
class YOLOLayer(nn.Module):
    def __init__(self, anchors, nc, img_size, yolo_index, layers, stride):
        """
        Class for building one YOLO layer.

        Parameters:
          anchors - a list of anchor numbers: (3, )
          nc - number of classes
          img_size - processed image size
          yolo_index - a scalar indicating the current yolo index
          layers - mdef['from'] or mdef['yolo']
          stride - stride[yolo_index]
        """
