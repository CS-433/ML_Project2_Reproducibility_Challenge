...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    Parameters:
      hyp - a dictionary of hyper-params
      opt- parser object containing all the input arguments
      device - torch.device('cuda') if cuda is used
    ...
    # Set scheduler https://arxiv.org/pdf/1812.01187.pdf
    ...
    # Use dataloader to get training set loader
...
if __name__ == '__main__':
    ...
    # Evolve hyper-parameters (optional)
        ...
        # Hyper-parameter evolution metadata (mutation scale 0-1, lower_limit, upper_limit)
